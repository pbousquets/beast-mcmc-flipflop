...
def simulate_fcpgs(N, S, lam, mu, gamma, delta, eta, kappa, random_tree, tree_file, seed, samples, eff_pop_size, time, root_limits, directory, output, no_tree):
    np.random.seed(seed)
...
def main(N, S, lam, mu, gamma, delta, eta, kappa, rlam, rmu, metbias, rdelta, reta, rkappa, random_tree, tree_file, seed, samples, eff_pop_size, time, root_limits, directory, output, no_tree):
    ...
    simulate_fcpgs(N, S, lam, mu, gamma, delta, eta, kappa, random_tree, tree_file, seed, samples, eff_pop_size, time, root_limits, directory, output, no_tree)
