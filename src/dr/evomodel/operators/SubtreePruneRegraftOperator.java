 ...
 * trees. It assumes explicitly bifurcating rooted trees.
 *
 * @author Sebastian Hoehna
 * @version 1.0
 */
public class SubtreePruneRegraftOperator extends AbstractTreeOperator {

    private TreeModel tree = null;
    /**
     *
     */
    public SubtreePruneRegraftOperator(TreeModel tree, double weight) {
        this.tree = tree;
        setWeight(weight);
