 ...
 */
public class GeneralFrequencyModelParser extends AbstractXMLObjectParser {
    public static final String FREQUENCIES = "frequencies";
    public static final String FREQUENCY_MODEL = "generalFrequencyModel";
    ...
    public Class getReturnType() {
        return GeneralFrequencyModel.class;
    }
